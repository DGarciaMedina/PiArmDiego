...
def train(sess, env, args, actor, critic, actor_noise):
    ...
    ckpt_dir = r"C:\Users\diego\Documents\2019-2020\Engineering\IIB Project\Experiments\IIB_Project\PiArmDiego\results\tf_ddpg_params"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image-width', help='Width of the image used as the state', default=64)
    parser.add_argument('--image-height', help='Height of the image used as the state', default=64)
